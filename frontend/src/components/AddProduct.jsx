...
const AddProduct = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            title: Yup.string().required('please fill this field').min(3, "Title must be of at least 3 characters"),
            description: Yup.string().required('please fill this field').min(10, "Title must be of at least 10 characters").max(50, "Description can't be more than 50 characters"),
            price: Yup.number().required('please fill this field').min(100, "Price shall not be less than 100"),
            stock: Yup.number().required('please fill this field'),
            discount: Yup.number().required('please fill this field'),
            category: Yup.string().required('please fill this field').min(3, "Category must be of at least 3 characters").max(15, "Category can't be more than 15 characters"),
            productImage: Yup.mixed()
                ...
                .test(
                    ...
                    (value) => !value || (value && ["image/jpeg", "image/png", "image/webp"].includes(value.type))
                )
        }),
        onSubmit: (values) => {
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`mt-1 p-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                                formik.errors.title && formik.touched.title ? "border-red-500" : "border"
                            }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            className={`mt-1 p-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                                formik.errors.description && formik.touched.description ? "border-red-500" : "border"
                            }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="number"
                            className={`mt-1 p-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                                formik.errors.price && formik.touched.price ? "border-red-500" : "border"
                            } pr-10`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="number"
                            className={`mt-1 p-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                                formik.errors.stock && formik.touched.stock ? "border-red-500" : "border"
                            }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`mt-1 p-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                                formik.errors.discount && formik.touched.discount ? "border-red-500" : "border"
                            }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`mt-1 p-1 block w-full text-sm text-gray-200 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 ${
                                formik.errors.productImage && formik.touched.productImage ? "border-red-500" : "border"
                            }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="number"
                            className={`mt-1 p-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                                formik.errors.category && formik.touched.category ? "border-red-500" : "border"
                            }`}
                        />
